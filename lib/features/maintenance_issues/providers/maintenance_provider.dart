...
final maintenanceIssuesProvider = FutureProvider.family<MaintenanceIssuesResponse, ({int page, int limit, String? flatId})>((ref, params) async {
  final repository = ref.watch(maintenanceRepositoryProvider);
  final result = await repository.getIssues(page: params.page, limit: params.limit, flatId: params.flatId);
